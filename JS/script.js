...
description.innerText =
  "Pagination is used separate the data into multiple pages. This is a demo using API data from a public domain.";
description.style.color = "#1A237E";
description.style.marginTop = "10px";
description.style.marginBottom = "0px";


let container = elem("div", "class", "container");
let maindiv = elem("div", "id", "main-div");
let navbar = elem("nav", "id", "nav-bar");
let title = elem("h1", "id", "title");
title.innerHTML = "Pagination";
title.style.textAlign = "center";
title.style.marginBottom = "0";
title.style.marginTop = "30px";

function elem(tagname, attname, attvalue) {
